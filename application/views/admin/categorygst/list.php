                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">List Category Tax </h4>
                            ...
                            <div class="card-body collapse show">
                                ...
                                ?>
                                <a style="float:right;" href="<?php echo base_url();?>Admin/Categorygst?idd=<?php echo base64_encode($idH); ?>" class="btn btn-primary">Add Tax</a>
                                    ...
                                    <table class="table table-striped table-bordered file-export">
                                        ...
                                        foreach ($result as $row) :?>
                                            <tr>
                                                ...
                                                <td class="center">
                                                    <a href="<?php echo base_url(); ?>Admin/Categorygst?id=<?php echo base64_encode($row->catgst_id); ?>"
                                                       class="btn btn-primary">
                                                        Edit
                                                    </a>
                                                    <a class="btn btn-danger"
                                                       href="<?php echo base_url(); ?>Admin/Categorygst/deleteCategorygst?id=<?php echo base64_encode($row->catgst_id); ?>"
