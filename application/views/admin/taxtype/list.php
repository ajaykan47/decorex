                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">List Tax Type</h4>
                                    ...
                                    <table class="table table-striped table-bordered file-export">
                                        ...
                                        foreach ($result as $row) :?>
                                            <tr>
                                                ...
                                                <td class="center">
                                                    <a href="<?php echo base_url(); ?>Admin/Taxtype?id=<?php echo base64_encode($row->tax_id); ?>"
                                                       class="btn btn-primary">
                                                        Edit
                                                    </a>
                                                    <a class="btn btn-danger"
                                                       href="<?php echo base_url(); ?>Admin/Taxtype/deleteTaxtype?id=<?php echo base64_encode($row->tax_id); ?>"
