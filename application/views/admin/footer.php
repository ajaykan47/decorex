                        ...
                        <div id="chatapp" class="col-12">
                            ...
                            <div class="collection border-none">
                                <div class="media mb-1"><a><img alt="96x96"
                                                                src="<?php echo base_url();?>backend_assets/app-assets/img/portra/avatar-s-12.63.delaye"
                                ...
                                <div class="media mb-1"><a><img alt="96x96"
                                                                src="<?php echo base_url();?>backend_assets/app-assets/img/portrai/avatar-s-6.66.delaye"
                                                                class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                                    <div class="media-body">
                                        <div class="clearfix">
                                ...
                                <div class="media mb-1"><a><img alt="96x96"
                                                                src="<?php echo base_url();?>backend_assets/app-assets/img/portra/avatar-s-11.64.delaye"
                                                                class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                                    <div class="media-body">
                                        <div class="clearfix">
                                ...
                                <div class="media mb-1"><a><img alt="96x96"
                                                                src="<?php echo base_url();?>backend_assets/app-assets/img/portra/avatar-s-18.67.delaye"
                                                                class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                                    <div class="media-body">
                                        <div class="clearfix">
                                ...
                                <div class="media mb-1"><a><img alt="96x96"
                                                                src="<?php echo base_url();?>backend_assets/app-assets/img/portrai/avatar-s-1.68.delaye"
                                                                class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                                    <div class="media-body">
                                        <div class="clearfix">
                                ...
                                <div class="media mb-1"><a><img alt="96x96"
                                                                src="<?php echo base_url();?>backend_assets/app-assets/img/portrai/avatar-s-2.69.delaye"
                                                                class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                                    <div class="media-body">
                                        <div class="clearfix">
                                ...
                                <div class="media mb-1"><a><img alt="96x96"
                                                                src="<?php echo base_url();?>backend_assets/app-assets/img/portrai/avatar-s-3.65.delaye"
                                                                class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                                    <div class="media-body">
                                        <div class="clearfix">
                                ...
                                <div class="media mb-1"><a><img alt="96x96"
                                                                src="<?php echo base_url();?>backend_assets/app-assets/img/portra/avatar-s-15.6a.delaye"
                                                                class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                                    <div class="media-body">
                                        <div class="clearfix">
                                ...
                                <div class="media mb-1"><a><img alt="96x96"
                                                                src="<?php echo base_url();?>backend_assets/app-assets/img/portra/avatar-s-19.6b.delaye"
                                                                class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                                    <div class="media-body">
                                        <div class="clearfix">
                                ...
                                <div class="media mb-1"><a><img alt="96x96"
                                                                src="<?php echo base_url();?>backend_assets/app-assets/img/portra/avatar-s-14.6c.delaye"
                                                                class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                                    <div class="media-body">
                                        <div class="clearfix">
                                ...
                                <div class="media mb-1"><a><img alt="96x96"
                                                                src="<?php echo base_url();?>backend_assets/app-assets/img/portra/avatar-s-13.6d.delaye"
                                                                class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                                    <div class="media-body">
                                        <div class="clearfix">
                                ...
                                <div class="media mb-1"><a><img alt="96x96"
                                                                src="<?php echo base_url();?>backend_assets/app-assets/img/portra/avatar-s-22.6e.delaye"
                                                                class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                                    <div class="media-body">
                                        <div class="clearfix">
                                ...
                                <div class="media mb-1"><a><img alt="96x96"
                                                                src="<?php echo base_url();?>backend_assets/app-assets/img/portrai/avatar-s-9.6f.delaye"
                                                                class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                                    <div class="media-body">
                                        <div class="clearfix">
                                ...
                                <div class="media mb-1"><a><img alt="96x96"
                                                                src="<?php echo base_url();?>backend_assets/app-assets/img/portra/avatar-s-20.70.delaye"
                                                                class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                                    <div class="media-body">
                                        <div class="clearfix">
...
<div class="customizer border-left-blue-grey border-left-lighten-4 d-none d-sm-none d-md-block"><a
    ...
    <div data-ps-id="df6a5ce4-a175-9172-4402-dabd98fc9c0a" class="customizer-content p-3 ps-container ps-theme-dark">
        ...
        <div class="cz-bg-image row">
            <div class="col mb-3"><img src="<?php echo base_url(); ?>backend_assets/app-assets/img/sidebar-bg/01.jpg"
                                       width="90" class="rounded"></div>
            <div class="col mb-3"><img src="<?php echo base_url(); ?>backend_assets/app-assets/img/sidebar-bg/02.jpg"
                                       width="90" class="rounded"></div>
            <div class="col mb-3"><img src="<?php echo base_url(); ?>backend_assets/app-assets/img/sidebar-bg/03.jpg"
                                       width="90" class="rounded"></div>
            <div class="col mb-3"><img src="<?php echo base_url(); ?>backend_assets/app-assets/img/sidebar-bg/04.jpg"
                                       width="90" class="rounded"></div>
            <div class="col mb-3"><img src="<?php echo base_url(); ?>backend_assets/app-assets/img/sidebar-bg/05.jpg"
                                       width="90" class="rounded"></div>
            <div class="col mb-3"><img src="<?php echo base_url(); ?>backend_assets/app-assets/img/sidebar-bg/06.jpg"
                                       width="90" class="rounded"></div>
        </div>
...
<script src="<?php echo base_url(); ?>backend_assets/app-assets/vendors/j/chartist.min.7f.delaye"
        type="text/javascript"></script>
<!-- END PAGE VENDOR JS-->
<!-- BEGIN APEX JS-->
...
<!-- Mirrored from pixinvent.com/apex-angular-4-bootstrap-admin-template/html-demo-1/dashboard2.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 09 Mar 2018 07:07:32 GMT -->
</html>