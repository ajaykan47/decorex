                                ...
                                <div class="card-block card-dashboard">
                                    ...
                                    <table class="table table-striped table-bordered file-export">
                                        ...
                                        foreach($result as $row) :?>
                                            <tr>
                                                <td><?php echo $sn++; ?></td>
                                                <td><img style="width: 60px; height: 56px;  " src="<?php echo base_url();?>uploads/quality/<?php echo $row->filename; ?>"></td>
                                                ...
                                                <td class="center">
                                                    <a  href="<?php echo base_url();?>Admin/Quality?id=<?php  echo base64_encode($row->quality_id); ?>" class="btn btn-primary">
                                                        Edit
                                                    </a>
                                                    <a class="btn btn-danger" href="<?php echo base_url();?>Admin/Quality/deleteBanner?id=<?php echo $row->quality_id; ?>" onclick="return confirm('Would you want to delete?');">Delete</a>
