                                ...
                                <div class="card-block card-dashboard">
                                    ...
                                    <table class="table table-striped table-bordered file-export">
                                        ...
                                        foreach($result as $row) :?>
                                            <tr>
                                                <td><?php echo $sn++; ?></td>
                                                <td><img style="width: 60px; height: 56px;  " src="<?php echo base_url();?>uploads/review/<?php echo $row->filename; ?>"></td>
                                                <td><?php echo $row->name; ?></td>
                                                <td><?php echo $row->star_rating; ?></td>
                                                <td><?php echo $row->e_mail; ?></td>
                                                <td><?php echo substr($row->full_descr,0,30); ?></td>
                                                <td><?php echo $row->created_at; ?></td>
                                                <td><?php echo $row->updated_at; ?></td>
                                                <td><?php if($row->status=='active'){echo
                                                    '<label class="btn btn-raised btn-success"> Publish </label>';
                                                    }else{
                                                        echo   '<label class="label btn-warning"> Unpublish </label>';
                                                    } ?></td>
                                                <td class="center">
                                                    <a  href="<?php echo base_url();?>Admin/Review?id=<?php  echo base64_encode($row->review_id); ?>" class="btn btn-raised btn-success">
                                                        Edit
                                                    </a>
                                                    <a class="btn btn-raised btn-danger" href="<?php echo base_url();?>Admin/Review/deleteReview?id=<?php echo base64_encode($row->review_id); ?>" onclick="return confirm('Would you want to delete banner ?');">Delete</a>
