                                ...
                                <div class="card-block card-dashboard">
                                    ...
                                    <table class="table table-striped table-bordered file-export">
                                        ...
                                        foreach($result as $row) :?>
                                            <tr>
                                                <td><?php echo $sn++; ?></td>
                                                <td><img style="width: 60px; height: 56px;  " src="<?php echo base_url();?>uploads/banner/<?php echo $row->filename; ?>"></td>
                                                <td><?php echo $row->title; ?></td>
                                                <td><?php echo $row->descr; ?></td>
                                                <td><?php echo $row->created_at; ?></td>
                                                <td><?php echo $row->updated_at; ?></td>
                                                <td><?php if($row->status=='active'){echo
                                                    '<label class="btn btn-raised btn-success"> Active </label>';
                                                    }else{
                                                        echo   '<label class="label btn-warning"> InActive </label>';
                                                    } ?></td>
                                                <td class="center">
                                                    <a  href="<?php echo base_url();?>Admin/Banner?id=<?php  echo base64_encode($row->banner_id); ?>" class="btn btn-raised btn-success">
                                                        Edit
                                                    </a>
                                                    <a class="btn btn-raised btn-danger" href="<?php echo base_url();?>Admin/Banner/deleteBanner?id=<?php echo base64_encode($row->banner_id); ?>" onclick="return confirm('Would you want to delete banner ?');">Delete</a>
