                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-header">
                                <h4 class="card-title">List  Testimonial
                                ...
                                <div class="card-block card-dashboard">
                                    ...
                                    <table class="table table-striped table-bordered file-export">
                                        ...
                                        foreach ($result as $row) :?>
                                            <tr>
                                                <td><?php echo $sn++; ?>
                                                <td><img style="width: 60px; height: 56px;  " src="<?php echo base_url();?>uploads/testimonial/<?php echo $row->image_file; ?>"></td>

                                                <td><?php echo $row->tml_name; ?></td>
                                                ...
                                                <td class="center">
                                                    <a href="<?php echo base_url(); ?>Admin/Testimonial?id=<?php echo base64_encode($row->tml_id); ?>"
                                                       class="btn btn-primary">
                                                        Edit
                                                    </a>
                                                    <a class="btn btn-danger"
                                                       href="<?php echo base_url(); ?>Admin/Testimonial/deleteTestimonial?id=<?php echo base64_encode($row->tml_id); ?>"
