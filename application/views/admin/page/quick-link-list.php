                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Quick Link List  </h4>
                            </div>
                                    ...
                                    <table class="table table-striped table-bordered file-export">
                                        ...
                                        foreach ($result as $row) :?>
                                            <tr>
                                                ...
                                                <td class="center">
                                                    <a href="<?php echo base_url(); ?>Admin/Page/quickLink?id=<?php echo base64_encode($row->usefl_id); ?>"
                                                       class="btn btn-primary">
                                                        Edit
                                                    </a>
                                                    <a class="btn btn-danger"
                                                       href="<?php echo base_url(); ?>Admin/Page/deleteQlink?id=<?php echo base64_encode($row->usefl_id); ?>"
