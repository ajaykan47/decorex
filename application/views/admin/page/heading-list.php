                                    ...
                                    <table class="table table-striped table-bordered file-export">
                                        ...
                                        foreach ($result as $row) :?>
                                            <tr>
                                                ...
                                                <td><?php echo substr($row->head_descr,0,100); ?></td>
                                                ...
                                                <td class="center">
                                                    <a href="<?php echo base_url(); ?>Admin/Page/heading?id=<?php echo base64_encode($row->hd_id); ?>"
                                                       class="btn btn-primary">
                                                        Edit
                                                    </a>
                                                    <!--<a class="btn btn-danger"
                                                       href="<?php echo base_url(); ?>Admin/Page/deleteheading?id=<?php echo base64_encode($row->hd_id); ?>"
