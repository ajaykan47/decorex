                                    ...
                                    <table class="table table-striped table-bordered file-export">
                                        ...
                                        foreach ($result as $row) :?>
                                            <tr>
                                                ...
                                                <td class="center">
                                                    <a href="<?php echo base_url(); ?>Admin/Page/whyChooseUs?id=<?php echo base64_encode($row->faq_id); ?>"
                                                       class="btn btn-primary">
                                                        Edit
                                                    </a>
                                                    <a class="btn btn-danger"
                                                       href="<?php echo base_url(); ?>Admin/Page/deleteWhy?id=<?php echo base64_encode($row->faq_id); ?>"
