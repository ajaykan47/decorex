                                    ...
                                    <table class="table table-striped table-bordered file-export">
                                        ...
                                        foreach ($result as $row) :?>
                                            <tr>
                                                ...
                                                <td><?php echo $row->seo_descr; ?></td>
                                                <td><?php echo $row->created_at; ?></td>
                                                <td><?php echo $row->updated_at; ?></td>

                                                <td class="center">
                                                    <a href="<?php echo base_url(); ?>Admin/MetaTag?id=<?php echo base64_encode($row->seo_id); ?>"
                                                       class="btn btn-primary">
                                                        Edit
                                                    </a>
                                                    <a class="btn btn-danger"
                                                       href="<?php echo base_url(); ?>Admin/MetaTag/deleteMetaTag?id=<?php echo $row->seo_id; ?>"
