                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <?php if ($this->session->flashdata('updateError')) { ?>
                                    <p style="float: right;" class="disMes alert alert-danger">Social Link Information
                                        is not successfully updated...!</p>
                                <?php } ?>
                                <?php if ($this->session->flashdata('delete')) { ?>
                                    <p style="float: right;" class="disMes alert alert-success">Social Link Information
                                        Successfully Deleted...! </p>
                                <?php } ?>

                                <?php if ($this->session->flashdata('delError')) { ?>
                                    <p style="float: right;" class="disMes alert alert-danger">Social Link Information
                                        Not Deleted. Please Try Again...! </p>
                                <?php } ?>
                            </div>
                                    ...
                                    <table class="table table-striped table-bordered file-export">
                                        ...
                                        foreach ($result as $row) :?>
                                            <tr>
                                                ...
                                                <td class="center">
                                                    <a href="<?php echo base_url(); ?>Admin/Setting/socialIcon?id=<?php echo base64_encode($row->socialicon_id); ?>"
                                                       class="btn btn-primary">
                                                        Edit
                                                    </a>
                                                    <a class="btn btn-danger"
                                                       href="<?php echo base_url(); ?>Admin/Setting/deleteSocialIconLink?id=<?php echo $row->socialicon_id; ?>"
                                                       onclick="return confirm('Would you want to delete website information...??');">Delete</a>
