...
<?php
$buttoName = '';
if (!empty($editResult[0]->socialicon_id)) {
    $frmaction = base_url() . "Admin/Setting/updateSocialLink";
    $buttoName = 'Save Changes ';
    $BtnClass = 'btn btn-raised btn-danger';
} else {
    $frmaction = base_url() . "Admin/Setting/addSocialIcon";
    $buttoName = 'Add Social Link';
    $BtnClass = 'btn btn-raised gradient-purple-bliss white shadow-z-1-hover';
}
	    ...
	    <div class="col-md-12">
	        <div class="card">
	            <div class="card-header">
	                <h4 class="card-title" id="horz-layout-basic">Social Icon Link Setting</h4>
	            ...
	            <div class="card-body">
                    <?php if ($this->session->flashdata('done')) { ?>
                        <p style="float: right;" class="disMes alert alert-success">Successfully Save Social Site Link</p>
                    <?php } ?>

                    <?php if ($this->session->flashdata('error')) { ?>
                        <p style="float: right;" class="disMes alert alert-danger">Social Site Link not Save Successfully Please Try Again !!</p>
                    <?php } ?>
	                <div class="px-3">
		                        ...
		                        <div class="form-group row">
									...
									<div class="col-md-9">
		                            	<input type="text" id="txtFacebook" name="txtName" class="form-control"
                                               value="<?php if(!empty($editResult)){ echo $editResult[0]->name;}?>">
		                            </div>
		                        </div>
                                <input type="hidden" name="hidden_id" value="<?php if(!empty($editResult)){ echo $editResult[0]->socialicon_id;}?>">
								 ...
								 <div class="form-group row">
									...
									<div class="col-md-9">
                                        ...
                                        value="<?php if(!empty($editResult)){ echo $editResult[0]->link ;}?>">
		                            </div>
		                        </div>
                                <div class="form-group row">
