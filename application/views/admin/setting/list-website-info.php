                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <?php if ($this->session->flashdata('update')) { ?>
                                    <p style="float: right;" class="disMes alert alert-success">Web Information Successfully updated...!</p>
                                <?php } ?>

                                <?php if ($this->session->flashdata('updateError')) { ?>
                                    <p style="float: right;" class="disMes alert alert-danger">Web Information is not successfully updated...!</p>
                                <?php } ?>
                                <?php if ($this->session->flashdata('delete')) { ?>
                                    <p style="float: right;" class="disMes alert alert-success">Web Information Successfully Deleted...! </p>
                                <?php } ?>

                                <?php if ($this->session->flashdata('delError')) { ?>
                                    <p style="float: right;" class="disMes alert alert-danger">Web Information Not Deleted. Please Try Again...! </p>
                                <?php } ?>
                            </div>
                                ...
                                <div class="card-block card-dashboard">
                                    ...
                                    <table class="table table-striped table-bordered file-export">
                                        ...
                                        foreach($result as $row) :?>
                                            <tr>
                                                <td><?php echo $sn++; ?></td>
                                                <td><img style="width: 60px; height: 56px;  " src="<?php echo base_url();?>uploads/logo/<?php echo $row->filename; ?>"></td>
                                                <td><?php echo $row->company_name; ?></td>
                                                <td><?php echo $row->mobile; ?></td>
                                                <td><?php echo $row->personal_email; ?></td>
                                                <td><?php echo substr($row->branch_add,0,20); ?></td>
