                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">our Client Tag List </h4>
                            </div>
                                    ...
                                    <table class="table table-striped table-bordered file-export">
                                        ...
                                        foreach ($result as $row) :?>
                                            <tr>
                                                ...
                                                <td><img style="width: 60px; height: 56px;  " src="<?php echo base_url();?>uploads/ourclient/<?php echo $row->client_logo; ?>"></td>
                                                ...
                                                <td class="center">
                                                    <a href="<?php echo base_url(); ?>Admin/OurClient?id=<?php echo base64_encode($row->client_id); ?>"
                                                       class="btn btn-primary">
                                                        Edit
                                                    </a>
                                                    <a class="btn btn-danger"
                                                       href="<?php echo base_url(); ?>Admin/OurClient/deleteOurClient?id=<?php echo base64_encode($row->client_id) ; ?>"
