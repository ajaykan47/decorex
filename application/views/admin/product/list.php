                                ...
                                <div class="card-block card-dashboard">
                                    ...
                                    <table class="table table-striped table-bordered file-export">
                                        ...
                                        foreach($result as $row) :?>
                                            <tr>
                                                <td><?php echo $sn++; ?></td>
                                                <td><img style="width: 60px; height: 56px;  " src="<?php echo base_url();?>uploads/product/<?php echo $row->filename; ?>"></td>
                                                <td><?php echo $row->name; ?></td>
                                                <td><?php echo $row->p_name; ?></td>
                                                <td><?php echo substr($row->short_descr,0,50); ?></td>
                                                ...
                                                <td class="center">
                                                    <a  href="<?php echo base_url();?>Admin/Product?id=<?php  echo base64_encode($row->product_id); ?>" class="btn btn-primary">
                                                        Edit
                                                    </a>
                                                   <!-- <a  href="<?php echo base_url();?>Admin/Product/ShowSeo?id=<?php  echo base64_encode($row->product_id); ?>" class="btn btn-primary">
                                                        View
                                                    </a>-->
