                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Technical Specification List </h4>
                                ...
                                <div class="card-block card-dashboard">
                                    ...
                                    <table class="table table-striped table-bordered file-export table-responsive">
                                        ...
                                        <tr>
                                            ...
                                            <th>Table Top Sliding</th>
                                            <th>Trendelenburg</th>
                                            <th>lateral Tilt</th>
                                            <th>Kidney elevator </th>
                                            <th>Back Rest </th>
                                           <th>Leg Rest </th>
                                            <th>Head Res </th>
                                            <th>Power supply</th>
                                            <th>Battery Backup</th>
                                            <th>Patient Weight Capacity</th>
                                            <th>Date</th>
                                            <th>Update</th>
                                            <th>Action</th>
                                        ...
                                        foreach($result as $row) :?>
                                            <tr>
                                                ...
                                                <td><?php echo $row->top_dimension; ?></td>
                                                <td><?php echo $row->height_adjustment; ?></td>
                                                <td><?php echo $row->table_top_sliding; ?></td>
                                                <td><?php echo $row->trendelenburg  ; ?></td>
                                                <td><?php echo $row->lateral_tilt; ?></td>
                                                <td><?php echo $row->kidney; ?></td>
                                               <td><?php echo $row->back_rest; ?></td>
                                                <td><?php echo $row->leg_rest; ?></td>
                                                <td><?php echo $row->head_rest; ?></td>
                                                <td><?php echo $row->Power_supply; ?></td>
                                                <td><?php echo $row->battery_backup; ?></td>
                                                <td><?php echo $row->capacity_supply; ?></td>
                                               ...
                                               <!-- <td><?php /*if($row->status=='Active'){echo
                                                ...
                                                <td class="center">
                                                    <a  href="<?php echo base_url();?>Admin/Product/TechnicalSpecification?id=<?php  echo base64_encode($row->ts_id); ?>" class="btn btn-primary">
                                                        Edit
                                                    </a>
                                                    <a class="btn btn-danger" href="<?php echo base_url();?>Admin/Product/deleteSpecification?id=<?php echo base64_encode($row->ts_id); ?>" onclick="return confirm('Would you want to delete technical specification ?');">Delete</a>
                    ...
                    <div id="chat-tab" aria-labelledby="base-tab2" class="tab-pane">
                        <div id="chatapp" class="col-12">
                            ...
                            <div class="collection border-none">
                                <div class="media mb-1"><a><img alt="96x96" src="app-assets/img/portra/avatar-s-12.63.delaye" class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                                ...
                                <div class="media mb-1"><a><img alt="96x96" src="app-assets/img/portrai/avatar-s-6.66.delaye" class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                                    <div class="media-body">
                                        <div class="clearfix">
                                ...
                                <div class="media mb-1"><a><img alt="96x96" src="app-assets/img/portra/avatar-s-11.64.delaye" class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                                    <div class="media-body">
                                        <div class="clearfix">
                                ...
                                <div class="media mb-1"><a><img alt="96x96" src="app-assets/img/portra/avatar-s-18.67.delaye" class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                                    <div class="media-body">
                                        <div class="clearfix">
                                ...
                                <div class="media mb-1"><a><img alt="96x96" src="app-assets/img/portrai/avatar-s-1.68.delaye" class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                                    <div class="media-body">
                                        <div class="clearfix">
                                ...
                                <div class="media mb-1"><a><img alt="96x96" src="app-assets/img/portrai/avatar-s-2.69.delaye" class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                                    <div class="media-body">
                                        <div class="clearfix">
                                ...
                                <div class="media mb-1"><a><img alt="96x96" src="app-assets/img/portrai/avatar-s-3.65.delaye" class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                                    <div class="media-body">
                                        <div class="clearfix">
                                ...
                                <div class="media mb-1"><a><img alt="96x96" src="app-assets/img/portra/avatar-s-15.6a.delaye" class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                                    <div class="media-body">
                                        <div class="clearfix">
                                ...
                                <div class="media mb-1"><a><img alt="96x96" src="app-assets/img/portra/avatar-s-19.6b.delaye" class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                                    <div class="media-body">
                                        <div class="clearfix">
                                ...
                                <div class="media mb-1"><a><img alt="96x96" src="app-assets/img/portra/avatar-s-14.6c.delaye" class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                                    <div class="media-body">
                                        <div class="clearfix">
                                ...
                                <div class="media mb-1"><a><img alt="96x96" src="app-assets/img/portra/avatar-s-13.6d.delaye" class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                                    <div class="media-body">
                                        <div class="clearfix">
                                ...
                                <div class="media mb-1"><a><img alt="96x96" src="app-assets/img/portra/avatar-s-22.6e.delaye" class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                                    <div class="media-body">
                                        <div class="clearfix">
                                ...
                                <div class="media mb-1"><a><img alt="96x96" src="app-assets/img/portrai/avatar-s-9.6f.delaye" class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                                    <div class="media-body">
                                        <div class="clearfix">
                                ...
                                <div class="media mb-1"><a><img alt="96x96" src="app-assets/img/portra/avatar-s-20.70.delaye" class="media-object d-flex mr-3 bg-primary height-50 rounded-circle"></a>
                                    <div class="media-body">
                                        <div class="clearfix">
...
<!-- BEGIN VENDOR JS-->
<script src="<?php echo base_url();?>backend_assets/app-assets/vendors//jquery-3.2.1.min.77.del" type="text/javascript"></script>
<script src="<?php echo base_url();?>backend_assets/app-assets/vendors/js//popper.min.78.delaye" type="text/javascript"></script>
<script src="<?php echo base_url();?>backend_assets/app-assets/vendors//bootstrap.min.79.delaye" type="text/javascript"></script>
<script src="<?php echo base_url();?>backend_assets/app-assets/vendors//perfect-scrollbar.jquer" type="text/javascript"></script>
<script src="<?php echo base_url();?>backend_assets/app-assets/vendors/js/prism.min.js" type="text/javascript"></script>
<script src="<?php echo base_url();?>backend_assets/app-assets/vendors//jquery.matchHeight-min" type="text/javascript"></script>
<script src="<?php echo base_url();?>backend_assets/app-assets/vendors//screenfull.min.7d.delay" type="text/javascript"></script>
<script src="<?php echo base_url();?>backend_assets/app-assets/vendors/js/pa/pace.min.7e.delaye" type="text/javascript"></script>
<!-- BEGIN VENDOR JS-->
<!-- BEGIN PAGE VENDOR JS-->
<script src="<?php echo base_url();?>backend_assets/app-assets/vendors//datatables.min.f1.delay" type="text/javascript"></script>
<script src="<?php echo base_url();?>backend_assets/app-assets/vendors//dataTables.buttons.min" type="text/javascript"></script>
<script src="<?php echo base_url();?>backend_assets/app-assets/vendors//buttons.flash.min.f4.de" type="text/javascript"></script>
<script src="<?php echo base_url();?>backend_assets/app-assets/vendors/js/d/jszip.min.f5.delaye" type="text/javascript"></script>
<script src="<?php echo base_url();?>backend_assets/app-assets/vendors/js/pdfmake.min.f6.delaye" type="text/javascript"></script>
<script src="<?php echo base_url();?>backend_assets/app-assets/vendors/js/d/vfs_fonts.f7.delaye" type="text/javascript"></script>
<script src="<?php echo base_url();?>backend_assets/app-assets/vendors//buttons.html5.min.f8.de" type="text/javascript"></script>
<script src="<?php echo base_url();?>backend_assets/app-assets/vendors//buttons.print.min.f9.de" type="text/javascript"></script>
<!-- END PAGE VENDOR JS-->
<!-- BEGIN APEX JS-->
<script src="<?php echo base_url();?>backend_assets/app-assets/js/app-sidebar.js" type="text/javascript"></script>
<script src="<?php echo base_url();?>backend_assets/app-assets/js/notification-sidebar.81.delay" type="text/javascript"></script>
<script src="<?php echo base_url();?>backend_assets/app-assets/js/customizer.js" type="text/javascript"></script>
<!-- END APEX JS-->
<!-- BEGIN PAGE LEVEL JS-->
<script src="<?php echo base_url();?>backend_assets/app-assets/js/data-/datatable-advanced.fa.d" type="text/javascript"></script>
<!-- END PAGE LEVEL JS-->
<script>
