                                        ...
                                        if(!empty($result)) {
                                            ...
                                            foreach ($result as $row) :?>
                                                <tr>
                                                    ...
                                                    <!--<td><img style="width: 60px; height: 56px;  "
                                                             src="">
                                                    </td>-->
                                                    <td><img style="width: 126px; height: 100px;  "
                                                             src="<?php echo base_url(); ?>uploads/gallery/<?php echo $row->filename; ?>">
                                                    </td>
                                                    ...
                                                    <td class="center">
                                                        <a href="<?php echo base_url();?>Admin/Gallery/deletegallery?id=<?php echo base64_encode($row->gallery_id); ?>" class="btn btn-danger"
                                                           onclick="return confirm('Would you want to delete gallery image...?');">Delete</a>
                                                    </td>
                                                </tr>
                                            <?php endforeach;
                                        }?>
